  ...
  return(
    <div className="flex flex-col h-screen w-screen text-slate-900 bg-slate-200 overflow-x-hidden">
      ...
      <div className="grid sm:grid-cols-3 grid-cols-1 mx-5 text-center place-items-center mb-auto">
        ...
        <img className="max-h-[90%] sm:h-fit h-2/3 my-10 lg:px-16 px-3 hover:scale-110 transition duration-700" src="../images/machine-on-grass.jpg" alt="machine on grass" />
        ...
        <img className="max-h-[90%] sm:h-fit h-2/3 my-10 lg:px-16 px-3 hover:scale-110 transition duration-700" src="../images/machine-by-ocean.jpg" alt="machine by ocean" />
      </div>
