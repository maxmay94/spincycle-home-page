...
const SectionOne = () => {
  ...
  return (
    <div className="w-screen grid grid-cols-8 gap-4 bg-slate-200 text-slate-900 py-10">
      ...
      <div className="md:col-span-3 col-start-2 col-end-8 py-10 px-20 md:px-10 lg:px-20">
      ...
      <div className="md:col-span-2 col-start-2 col-span-6 my-auto">
        <p className="font-vollkorn text-center px-10 md:px-0">Don't worry about your laundry. From         wash-and-fold to dry cleaning and everything in-between we've got you covered door-to-door.
        <br />
        <br />
      ...
      <div className="md:col-span-3 col-start-2 col-end-8 py-10 my-auto px-20 md:px-10 lg:px-20">
