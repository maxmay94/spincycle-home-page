const MainHeader = () => {
  ...
  return (
    <div className="bg-shallow-depth-cover h-screen w-screen bg-cover sm:bg-fixed pb-40 text-slate-900 flex">
      ...
      <div className="mt-96 h-fit w-fit md:w-2/3 p-3 pr-20 backdrop-hue-rotate-180 backdrop-saturate-200 hover:backdrop-contrast-150"> 

        <div className="bg-yellow-200/30 hover:bg-red-200/30 w-[80vw] p-3">
